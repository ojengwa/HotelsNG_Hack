...
def getEmailWeight(key, value, cancelled):
    # v =  isPublicEmail(entry["email_address"])
    # cancelled =  entry["cancelled"]
    if (value =='0' and cancelled == '0'):
    ...
    for customer in customers:
        ...
        for feature in customer:
            if weights.has_key(feature):
                # print(feature)
                feature_weight = get_feature_weight(feature, customer[feature], str(customer['cancelled']))
